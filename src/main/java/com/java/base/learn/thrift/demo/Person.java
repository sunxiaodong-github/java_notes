...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MERRIED_FIELD_DESC = new org.apache.thrift.protocol.TField("merried", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean merried; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USERNAME((short)1, "username"),
    AGE((short)2, "age"),
    MERRIED((short)3, "merried");
  ...
  private static final int __MERRIED_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USERNAME,_Fields.AGE,_Fields.MERRIED};
  ...
  static {
    ...
    tmpMap.put(_Fields.MERRIED, new org.apache.thrift.meta_data.FieldMetaData("merried", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Person setMerried(boolean merried) {
    this.merried = merried;
    setMerriedIsSet(true);
    return this;
  }

  public void unsetMerried() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MERRIED_ISSET_ID);
  }

  /** Returns true if field merried is set (has been assigned a value) and false otherwise */
  public boolean isSetMerried() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MERRIED_ISSET_ID);
  }

  public void setMerriedIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MERRIED_ISSET_ID, value);
  }
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_merried = true && this.isSetMerried();
    boolean that_present_merried = true && that.isSetMerried();
    if (this_present_merried || that_present_merried) {
      if (!(this_present_merried && that_present_merried))
        return false;
      if (this.merried != that.merried)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMerried()) ? 131071 : 524287);
    if (isSetMerried())
      hashCode = hashCode * 8191 + ((merried) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetMerried()).compareTo(other.isSetMerried());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMerried()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.merried, other.merried);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // MERRIED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.merried = iprot.readBool();
              struct.setMerriedIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMerried()) {
        oprot.writeFieldBegin(MERRIED_FIELD_DESC);
        oprot.writeBool(struct.merried);
        oprot.writeFieldEnd();
      }
